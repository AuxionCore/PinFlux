...
export default defineContentScript({
  ...
  `;
    ...
    function createChatOptionsBtn(
      ...
      const chatOptionsBtn: HTMLButtonElement =
      ...
      chatOptionsBtn.setAttribute(
        "aria-label",
        "Open pin conversation options"
      );
  ...
  `;
    ...
    (async () => {
      ...
      function createPinnedChat(
        ...
        const chatOptionsBtnRaper: HTMLDivElement =
          ...
          if (chatOptionsMenu) {
            ...
            if (deleteButton) {
              deleteButton.addEventListener("click", async () => {
                setTimeout(() => {
                  const deleteConversationConfirmButton =
