...
### Fixed
- **Bookmarks Dropdown Layout**: Improved bookmarks dropdown handling to prevent layout issues
  - Enhanced dropdown visibility and positioning logic
  - Fixed edge cases where dropdown could cause layout shifts
  - Improved overall stability of bookmarks menu
